export default function BarGraph({data}) {
  ...
  return (
    <div className='w-full max-w-3xl py-2 drop'>
        ...
        {months.map((month, index) => (
          <div key={index} className='flex flex-col items-center'>
            <div
              ...
              className='bg-gradient-to-t from-dark-green/90 to-medium-green rounded-lg shadow-xl hover:shadow-lg w-4 md:w-8 lg:w-8'></div>
